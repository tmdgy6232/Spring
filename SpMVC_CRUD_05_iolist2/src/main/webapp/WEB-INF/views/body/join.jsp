...
<fieldset>
   ...
   <div class="in-box">
      ...
      <div class="in-box">
      <label for="m_password">Password 확인</label><input type="password"
         name="m_password" id="m_re_password" placeholder="비밀번호를 입력하세요.">
   </div>
   <div class="in-box">
   ...
   <div class="in-box">
      <label for="m_tel">mobile</label> <input type="phone" name="m_tel"
